...
TREKCORE_SERIES = {
    'star-trek-discovery': {
        'base_url': 'https://discovery.trekcore.com',
        'episodes_url': 'https://discovery.trekcore.com/episodes/',
        'name': 'Star Trek: Discovery'
    },
    'star-trek-picard': {
        'base_url': 'https://picard.trekcore.com',
        'episodes_url': 'https://picard.trekcore.com/episodes/',
        'name': 'Star Trek: Picard'
    },
    'star-trek-strange-new-worlds': {
        'base_url': 'https://snw.trekcore.com',
        'episodes_url': 'https://snw.trekcore.com/episodes/',
        'name': 'Star Trek: Strange New Worlds'
    },
    'star-trek-lower-decks': {
        'base_url': 'https://lowerdecks.trekcore.com',
        'episodes_url': 'https://lowerdecks.trekcore.com/episodes/',
        'name': 'Star Trek: Lower Decks'
    },
    'star-trek-prodigy': {
        'base_url': 'https://prodigy.trekcore.com',
        'episodes_url': 'https://prodigy.trekcore.com/episodes/',
                ...
                if parent_row:
                    ...
                    if ep_num_cell:
                        ...
                        if episode_number:
                            ...
                            if episode_exists(existing_data, series_slug, episode_number):
                            ...
                            if screencaps:
                                ...
                                log(f"    ✅ {len(screencaps)} screencaps encontrados. Guardando...")
                                
                                # GUARDAR INMEDIATAMENTE
                                update_screencaps_json([item])
...
def main():
    ...
    for series_slug, series_info in TREKCORE_SERIES.items():
        scrape_series(series_slug, series_info)
        time.sleep(5)
